...
export default function FloatingActions() {
  ...
  const openWhatsApp = () => {
    if (!WHATSAPP_NUMBER) {
      toast.info("WhatsApp is being connected — the chat assistant can help you meanwhile.");
      return;
    }
    window.open(
      `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent("Hi! I want to know about One Stock Academy courses.")}`,
      "_blank"
    );
  };
